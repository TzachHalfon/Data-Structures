...
static void TestForEach()
{
	...
	else
	{
		...
		printf("%d , %d\n", *(int*)DoublyListGetData(DoublyListBegin(list)), *(int*)DoublyListGetData(DoublyListIterNext(DoublyListBegin(list))) );
	}
...
static void TestSplice()
{
	...
	DoublyListSplice(DoublyListBegin(list2), DoublyListBegin(list), DoublyListEnd(list));
